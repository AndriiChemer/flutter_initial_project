...
import 'package:iteo_libraries_example/presentation/page/add_event_calendar/event_details_page.dart';
import 'package:manage_calendar_events/manage_calendar_events.dart';

class EventListPage extends StatefulWidget {
  final String calendarId;

  EventListPage({required this.calendarId});
...
class _EventListPageState extends State<EventListPage> {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<CalendarEvent>?>(
        ...
        builder: (context, snapshot) {
          ...
          List<CalendarEvent> events = (snapshot.data?.reversed.toList() ?? [])..removeWhere((element) => tomorrow.isBefore(element.startDate!));
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Dismissible(
                ...
                child: ListTile(
                  title: Text(event.title ?? '----------- Title empty'),
  ...
  void _addEvent() async {
    ...
    CalendarEvent _newEvent = CalendarEvent(
      ...
      // attendees: Attendees(
      //   attendees: [
      //     Attendee(emailAddress: 'andrii.chemer@iteo.com', name: 'Andrii'),
      //   ],
      // ),
    );
    _myPlugin
